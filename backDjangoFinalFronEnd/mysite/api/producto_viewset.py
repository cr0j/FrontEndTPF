...
from mysite.modelos.producto.serializer import ProductoReadSerializer, ProductoUpdateSerializer
...
class ProductoViewSet(  
    ...
    read_serializer_class = ProductoReadSerializer
    update_serializer_class = ProductoUpdateSerializer

    serializer_class = ProductoReadSerializer   
    filter_backends = [django_filters.rest_framework.DjangoFilterBackend]
    filterset_fields = fields = ['id','nombre','precio','existencia']
